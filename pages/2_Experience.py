...
st.markdown(
    ...
    - **Universiti Tunku Abdul Rahman (UTAR)**  
      *Bachelor of Computer Science with Honours (Merit)*  
      _2021-01 ~ 2024-09_  📍 Kampar, Perak, Malaysia  
    """
)
st.divider()
