...
certificates = [
    ...
    {"path": "pages/RanDomSeed - Google - Fast or Slow_ Predict AI Model Runtime.png", "text": "Kaggle competition: RanDomSeed - Google - Fast or Slow_ Predict AI Model Runtimet 🥉", "caption": "Award 3"},
]
