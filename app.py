...
with col2:
    st.markdown(
        ...
        Hello! Welcome to my personal page :) I'm Dai Cheng Xiao, currently an Algorithm Engineer @ Imperial Vision and also a Research Intern @ the IFRC of Zhejiang University Binjiang Institute.
